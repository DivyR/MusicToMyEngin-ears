...
class CRNN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.avgpool(x)  # [batch, 3, 16, 209] -> [batch, 6, 8, 105]
        x = F.relu(self.conv2(x))  # [batch, 6, 105] -> [batch, 6, 1, 100]

        # RNN
        x = x.squeeze(2)  # [batch, 6, 1, 100] -> [batch, 6, 100]
